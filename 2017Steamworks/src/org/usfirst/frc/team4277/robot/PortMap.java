...
public interface PortMap {
	...
	public final static int CLIMBER_PWM = 5;
	public final static int SQUEEZER_PWM = 6; 
	public final static int PAN_PWM = 8;
	...
	public final static int CLIMBER_SONAR_OUTPUT = 2; ///digital output
	public final static int CLIMBER_SONAR_INPUT = 3; ///digital Input
	public final static int SQUEEZER_ZEROER_IO = 4;
	public final static int SQUEEZER_TWO_IO = 5; //signal
	public final static int SQUEEZER_ONE_IO = 6; //power
	public final static int DRIVE_SONAR = 7;
